...
public final class ActivityConstants {
    ...
    public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_ADMIN = Map.of(
            "userId", USER_ID,
    ...
    public static final Map<String, String> ALLOWED_FILTER_MAP_FOR_USER = Map.of(
            "assetType", ASSET_TYPE,
            "operation", OPERATION,
            "createdAt", CREATED_AT,
            "assetId", ASSET_ID,
    ...
    public static final Set<String> ALLOWED_SORT_FEILDS = Set.of("createdAt", "assetName", "assetType", "operation");
